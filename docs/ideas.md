...
## List of Ideas
<!--<span style="color: red;">[Project Idea 1](#project-idea-1) - description.</span>-->
...
[+](#idea-0101) OS setup scripts ....... ( <https://github.com/protoni/configs> )
...
[+](#idea-0410) LED matrix display v2 .. ( )
...
| Link                                  | Description                                             |
|---------------------------------------|---------------------------------------------------------|
| [+](#idea-001) Dead link finder       | ( Exists locally somewhere )                            |
| [+](#idea-002) Web audio visualizer   | ( <https://github.com/protoni/audio-visualizer-web> )   |
| [+](#idea-003) ASCII audio visualizer | ( <https://protoni.fi/Projects/Web/audio-visualizer/> ) |
-->
